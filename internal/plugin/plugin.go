...
func (p *Plugin) Generate(req *GenerateRequest, w io.Writer) error {
	...
	if true {
		...
		allCode += "func ConvertStringToNumeric[T int32 | int64 | float64](v string) T {\n"
		allCode += "\tvar result T\n"
		allCode += "\tswitch any(result).(type) {\n"
		allCode += "\tcase int32:\n"
		allCode += "\t\tvar n int32\n"
		allCode += "\t\tif _, err := fmt.Sscanf(v, \"%d\", &n); err == nil {\n"
		allCode += "\t\t\tresult = any(n).(T)\n"
		allCode += "\t\t}\n"
		allCode += "\tcase int64:\n"
		allCode += "\t\tvar n int64\n"
		allCode += "\t\tif _, err := fmt.Sscanf(v, \"%d\", &n); err == nil {\n"
		allCode += "\t\t\tresult = any(n).(T)\n"
		allCode += "\t\t}\n"
		allCode += "\tcase float64:\n"
		allCode += "\t\tvar n float64\n"
		allCode += "\t\tif _, err := fmt.Sscanf(v, \"%f\", &n); err == nil {\n"
		allCode += "\t\t\tresult = any(n).(T)\n"
		allCode += "\t\t}\n"
		allCode += "\t}\n"
		allCode += "\treturn result\n"
		allCode += "}\n\n"

		allCode += "func ConvertStringToNumericPtr[T *int32 | *int64 | *float64](v string) T {\n"
		allCode += "\tswitch any(T(nil)).(type) {\n"
		allCode += "\tcase *int32:\n"
		allCode += "\t\tvar n int32\n"
		allCode += "\t\tif _, err := fmt.Sscanf(v, \"%d\", &n); err == nil {\n"
		allCode += "\t\t\treturn any(&n).(T)\n"
		allCode += "\t\t}\n"
		allCode += "\t\treturn any((*int32)(nil)).(T)\n"
		allCode += "\tcase *int64:\n"
		allCode += "\t\tvar n int64\n"
		allCode += "\t\tif _, err := fmt.Sscanf(v, \"%d\", &n); err == nil {\n"
		allCode += "\t\t\treturn any(&n).(T)\n"
		allCode += "\t\t}\n"
		allCode += "\t\treturn any((*int64)(nil)).(T)\n"
		allCode += "\tcase *float64:\n"
		allCode += "\t\tvar n float64\n"
		allCode += "\t\tif _, err := fmt.Sscanf(v, \"%f\", &n); err == nil {\n"
		allCode += "\t\t\treturn any(&n).(T)\n"
		allCode += "\t\t}\n"
		allCode += "\t\treturn any((*float64)(nil)).(T)\n"
		allCode += "\t}\n"
		allCode += "\tvar zero T\n"
		allCode += "\treturn zero\n"
		allCode += "}\n\n"
