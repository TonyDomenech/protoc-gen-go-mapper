...
marcha de nuevo. La partida termina cuando uno de los jugadores alcanza
5 puntos. Podr\u00e1s pausar y reanudar con la tecla `P` y reiniciar con `R`
cuando aparezca el mensaje de victoria.
...
Puedes indicar cu\u00e1ntos puntos son necesarios para ganar modificando `scoreToWin` en el `GameManager`. Asigna un `Text` extra para mostrar el mensaje de victoria y tendr\u00e1s un contador que podr\u00e1 reiniciarse pulsando `R`.
