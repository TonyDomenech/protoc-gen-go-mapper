...
marcha de nuevo. La partida termina cuando un jugador alcanza 5 puntos.
Puedes pausar la acci\u00f3n pulsando `P` (o la barra espaciadora) y, una vez
finalizado el juego, reiniciarlo con `R`.
...
Puedes pausar en cualquier momento con `P` o la barra espaciadora y reiniciar con `R` cuando alguien gane.
